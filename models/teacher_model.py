...
class TeacherModel(nn.Module):
    ...
    """
    def __init__(self, image_size, in_channel, num_blocks, channels, num_classes=2, **kwargs):
        super().__init__()
        ih, iw = image_size
...
def teacher_model(**kwargs):
    num_blocks = [6, 6, 9]
    channels = [64, 96, 192]
    return TeacherModel((28, 28), 1, num_blocks, channels, **kwargs)  # 删除显式的 num_classes=2