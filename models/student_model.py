...
def student_model(**kwargs):
    num_blocks = [2, 2, 3, 3]
    channels = [64, 96, 192, 256]
    return StudentModel((28, 28), in_channel=3, num_blocks=num_blocks, channels=channels, patch_size=(2, 2), use_distillation=False, num_classes=8, **kwargs)

@register_model
def HDKD(**kwargs):
    num_blocks = [2, 2, 3, 3]
    channels = [64, 96, 192, 256]
    return StudentModel((28, 28), in_channel=3, num_blocks=num_blocks, channels=channels, patch_size=(2, 2), use_distillation=True, num_classes=8, **kwargs)