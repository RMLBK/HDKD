...
def student_model(**kwargs):
    ...
    return StudentModel((28, 28), 1, num_blocks, channels, patch_size=(2, 2), use_distillation=False, num_classes=2, **kwargs)

@register_model
def HDKD(**kwargs):
    num_blocks = [2, 2, 3, 3]
    channels = [64, 96, 192, 256]
    return StudentModel((28, 28), 1, num_blocks, channels, patch_size=(2, 2), use_distillation=True, num_classes=2, **kwargs)